...
<Image layout="responsive" width={60} height={5} src="/Clients/Logos/dynamatics.png"/>
</div>
</a></Link>
...
<div className={`${styles.center}`}>
<Image layout="responsive" width={60} height={20}  src="/Clients/Logos/cbc.png"/>
</div>
</a></Link>
<Link href="/Case-Studies/Gehna"><a className={`${styles.box} ${styles.five}`}>
<Image layout="fill" width={60} height={20} src="/Clients/Logos/gehna.png"/>
</a></Link>
<Link href="/Case-Studies/Aastha"><a className={`${styles.box} ${styles.six}`}>
<Image layout="fill" width={60} height={20} className="${styles.yellow}" src="/Clients/Logos/aastha.png"/>
</a></Link>
<Link href="/Case-Studies/Fox"><a className={`${styles.box} ${styles.three} `}>
<Image layout="fill" width={60} height={20} src="/Clients/Logos/fox.png"/>
</a></Link>
<Link href="/Case-Studies/Retreeve"><a href="./" className={`${styles.box} ${styles.four} ${styles.main}`}>
<Image layout="fill" width={60} height={20} src="/Clients/Logos/retreeve.png"/>
</a></Link>
<Link href="/Case-Studies/Surgems"><a className={`${styles.box} ${styles.eight}`}>
<div className={`${styles.center}`}>
<Image layout="responsive" width={60} height={20} src="/Clients/Logos/surgems.png"/>
</div>
</a></Link>
<Link href="/Case-Studies/Devi"><a className={`${styles.box} ${styles.nine}`}>
<div className={`${styles.center}`}>
<Image layout="responsive" width={60} height={20} src="/Clients/Logos/devi.png"/>
</div>
</a></Link>
</div>
